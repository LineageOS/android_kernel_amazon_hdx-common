...
//TODO: ask Synaptics about this missing #define, and whether
// LINUX_VERSION_CODE > KERNEL_VERSION(3.7.0) was intentional
#define SYNAPTICS_DSX_DRIVER_VERSION "DS4 1.01"
 ...
 * @regulator: pointer to associated 3V regulator
 * @digital_regulator: pointer to associated 1.8V regulator
...
struct synaptics_rmi4_data {
	...
	struct regulator *digital_regulator;
	...
	int sensor_max_x;
	int sensor_max_y;
	int id_gpio;      /* the id values as read from gpio, ID_VALID means it's valid value */
	int id_chip;      /* the chip rev id read from hw chip, ID_VALID means it's valid value */
